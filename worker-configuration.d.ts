/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env template` (hash: 34ced63fa2822a71a405e3caae18d36b)
// Runtime types generated with workerd@1.20250525.0 2025-04-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		godToken: string;
		mailgun: string;
		domains: string;
		defaultIncomingQuotaPerDay: string;
		defaultOutgoingQuotaPerDay: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "godToken" | "mailgun" | "domains" | "defaultIncomingQuotaPerDay" | "defaultOutgoingQuotaPerDay" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
